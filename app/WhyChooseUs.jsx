...
import FourthImage from "../public/images/w4.jpg";
    ...
    <div className={`${rubik.className} overflow-x-hidden`} id="services">
      <div className="py-8 p-8 flex flex-col justify-center items-center">
        <div className="flex flex-col justify-center items-center">
          ...
          >
            We assure our clients of continued support throughout and after the
            ...
            <div className="p-8 flex flex-col justify-between bg-base-300 rounded-b-box flex-1">
              <div>
                ...
                <p className="text-start text-md text-white">
                  ...
                  experience. We stay updated with the latest advancements to
                  ensure you receive top-quality service every time.
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="p-8 flex flex-col justify-between bg-base-300 rounded-b-box flex-1">
              <div>
                ...
                <p className="text-start text-md text-white">
                  ...
                  offer customized solutions designed to meet your specific
                  needs, ensuring optimal results and complete satisfaction.{" "}
                </p>
              </div>
            </div>
          </motion.div>
            ...
            <div className="p-8 flex flex-col justify-between bg-base-300 rounded-b-box flex-1">
              <div>
                ...
                <p className="text-start text-md text-white">
                  ...
                  materials we use to the craftsmanship we deliver, we guarantee
                  exceptional standards that you can rely on.{" "}
                </p>
              </div>
            </div>
          </motion.div>
